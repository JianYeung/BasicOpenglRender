...
public class ObjParser {
    ...
    public static List<Obj3D> readMultiObj(Context context, String file){
        tLog.i(TAG,"readMultiObj()");
        boolean isAssets;
        ArrayList<Obj3D> data=new ArrayList<>();
        ArrayList<Float> oVs=new ArrayList<Float>();     //原始顶点坐标列表
        ArrayList<Float> oVNs=new ArrayList<Float>();    //原始顶点法线列表
        ArrayList<Float> oVTs=new ArrayList<Float>();    //原始贴图坐标列表
      /*  ArrayList<Float> oFVs=new ArrayList<Float>();     //面顶点
        ArrayList<Float> oFVNs=new ArrayList<Float>();
        ArrayList<Float> oFVTs=new ArrayList<Float>();*/
        HashMap<String,MtlInfo> mTls=null;
        HashMap<String,Obj3D> mObjs=new HashMap<String,Obj3D>();
        Obj3D nowObj=null;
        MtlInfo nowMtl=null;
        try{
            String parent;
